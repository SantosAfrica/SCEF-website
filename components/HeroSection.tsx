...
const HeroSection: React.FC<HeroSectionProps> = ({ title, subtitle }) => (
    <section className="pl-4  md:pl-20 pt-8 md:pt-20 w-full text-center md:text-left">
        ...
        <div className="pt-8  flex gap-8 items-center justify-center md:justify-start md:pl-0">
            ...
            <button className="max-w-100px w-40 flex items-center pb-4 justify-center gap-4 font-poppins text-sm  md:w-auto mt-4 md:mt-0">
