                ...
                <div className="relative">
                    ...
                    <div className="flex flex-col  lg:flex-row justify-center gap-8 mb-8">
                        {displayedItems.map((item, index) => (
                            <div key={index} className="bg-[#F8F9FF] w-full lg:w-[411px] h-fit md-h-[529px] rounded-tl-[16px] shadow-lg border border-[#DFE4DE]">
                                <Image
                                    src={item.image}
                                    alt={item.title}
                                    width={412}
                                ...
                                />
                                <div className='p-6 min-h- h-1/3 lg-h-full'>
